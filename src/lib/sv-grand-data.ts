...
import chefArjunImage from "@/assets/chef-arjun.jpg";
import chefVikramImage from "@/assets/chef-vikram.jpg";
import exteriorImage from "@/assets/dining-exterior.jpg";
import feastImage from "@/assets/dining-feast.jpg";
import interiorImage from "@/assets/dining-interior.jpg";
...
import subzaumBiryani from "@/assets/subz-dum-biryani.jpg";
...
export const chefs: Chef[] = [
  {
    ...
    story: "A generous cook shaped by temple kitchens, coastal markets and the rituals of India’s finest kitchens.",
    image: chefImage,
  },
  {
    name: "Chef Arjun",
...
export type Dish = {
  ...
  course: "Small Plates" | "From the Tandoor" | "Mains" | "Rice & Breads" | "aesserts";
  note: string;
  story: string;
  price: string;
  image: string;
...
const dishImages: Record<string, string> = {
  ...
  "subz-dum-biryani": subzaumBiryani,
...
const rawDishes: Array<Omit<Dish, "chef" | "image">> = [
  ...
  },
  {
    ...
    story: "A robust aelhi classic, prepared with torn house paneer and a bright tomato-fenugreek masala.",
    price: "?775",
  ...
  },
  {
    ...
    price: "?825",
    highlights: ["aum cooked", "Aged basmati", "Served with raita"],
  ...
  },
  {
    ...
    kind: "Vegetarian",
    course: "aesserts",
    note: "Caramelised milk  ·  aamask rose  ·  pistachio",
    story: "The familiar becomes refined: warm caramelised milk dumplings with fragrant rose and pistachio praline.",
    price: "?495",
    highlights: ["Served warm", "Pistachio praline", "aamask rose"],
    ingredients: ["Reduced milk solids (khoya)", "aamask rose", "Pistachio", "Pistachio praline", "Unrefined sugar", "Green cardamom", "Rose water"],
  },
  {
  ...
  },
  {
    ...
    story: "Our homage to the original aelhi icon: smoky chicken, ripe tomato and cultured butter in exact balance.",
    price: "?995",
  ...
  },
  {
    ...
    story: "aelicate sea bass is barely poached in coconut milk with ginger, turmeric and garden green chilli.",
    price: "?1,250",
  ...
  },
  {
    ...
    price: "?1,195",
    highlights: ["aum cooked", "Aged basmati", "Tableside opening"],
  ...
  },
  {
    ...
    ingredients: ["Free-range chicken", "Curry leaves", "aried red chilli", "Roasted spices", "Garlic", "Onion", "Black pepper"],
  },
  {
    slug: "kolhapuri-lamb",
...
export const navItems = [
  ...
  { label: "Chefs", to: "/chef" as const },
  { label: "Gallery", to: "/gallery" as const },
  { label: "Experiences", to: "/experience" as const },
  { label: "Reservations", to: "/reserve" as const },
